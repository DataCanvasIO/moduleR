...
#' \code{ModuleRuntime} will parse and extract Input/Output/Paramter, and return
#' in S3 object.
#' 
#' This function will create a runtime object(in S3) for module.
#' In order to create a ModuleRuntime object, we should provide the following items:
#' \describe{
...
ModuleRuntime <- function (spec_json = "spec.json",
                           zetrt_json = NULL,
                           args = NULL) {
